 ...
 */
export function deleteAndShift(obj: Record<number, Client[]>, startKey: number, indexToDelete: number) {
  ...
  // Step 1: Delete the element from the starting array
  obj[startKey].splice(indexToDelete, 1)

  // Step 2 & 3: Shift elements from subsequent arrays
